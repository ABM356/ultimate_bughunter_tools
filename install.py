...
def print_banner():
    ...
    HopeUp Security Platform — Tool Installer v2.0
    """
    print(banner)
    time.sleep(1)
...
def print_final_message():
    """Prints the concluding message."""
    message = """
[*] All tools have been downloaded!
[*] They are located in the ~/hopeup directory.

[!] Next steps:
    [~] Run: ./hopeup dashboard       — to view the platform
    [~] Run: ./hopeup preflight       — to verify tool readiness
    [~] Run: ./hopeup scan -t TARGET  — to start an assessment
    [~] Or:  python3 webapp/app.py    — to launch the web dashboard
    """
    print(message)
